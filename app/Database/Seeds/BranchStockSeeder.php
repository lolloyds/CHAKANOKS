...
class BranchStockSeeder extends Seeder
{
    public function run()
    {
        ...
        $branchStock = [
            ...
            ['branch_id' => 1, 'item_id' => 2, 'quantity' => 5, 'expiry_date' => null, 'updated_at' => $now], // Soy Sauce (non-perishable)
            ['branch_id' => 1, 'item_id' => 10, 'quantity' => 25, 'expiry_date' => null, 'updated_at' => $now], // Cooking Oil (non-perishable)
            ['branch_id' => 1, 'item_id' => 9, 'quantity' => 20, 'expiry_date' => null, 'updated_at' => $now], // Salt (low stock)
