            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                ...
                <div class="form-group">
                    ...
                    <select id="role" name="role" required onchange="toggleFields()">
                        ...
                        <option value="Central Office Admin" <?= old('role') === 'Central Office Admin' ? 'selected' : '' ?>>Central Office Admin</option>
                        <option value="Branch Manager" <?= old('role') === 'Branch Manager' ? 'selected' : '' ?>>Branch Manager</option>
                        <option value="Inventory Staff" <?= old('role') === 'Inventory Staff' ? 'selected' : '' ?>>Inventory Staff</option>
                        <option value="Supplier" <?= old('role') === 'Supplier' ? 'selected' : '' ?>>Supplier</option>
                        <option value="Logistics Coordinator" <?= old('role') === 'Logistics Coordinator' ? 'selected' : '' ?>>Logistics Coordinator</option>
                        <option value="Franchise Manager" <?= old('role') === 'Franchise Manager' ? 'selected' : '' ?>>Franchise Manager</option>
                    </select>
                </div>
